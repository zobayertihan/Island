...
gltfLoader.load("../assets/treeline.glb", function (gltf) {
  ...
  gltfLoader.load("../assets/flower.glb", function (gltf) {
    ...
    for (let i = 0; i < 500; i++) {
      ...
      var instancedBlossom = new THREE.InstancedMesh(
        blossom.geometry,
        blossomMaterial,
        1
      );
      var instancedStem = new THREE.InstancedMesh(
        stem.geometry,
        stem.material,
        1
      );
...
gltfLoader.load("../assets/treeline.glb", function (gltf) {
  ...
  gltfLoader.load("../assets/tree.glb", function (gltf) {
    ...
    for (let i = 0; i < 80; i++) {
      ...
      var instancedTree = new THREE.InstancedMesh(
        tree.geometry,
        treeMaterial,
        1
      );
...
var car;
gltfLoader.load("../assets/scooter.glb", function (gltf) {
  car = gltf.scene;
  gltf.scene.traverse(function (node) {
    if (node.isMesh) {
      node.castShadow = true;
...
var mixer3;
var action3;
gltfLoader.load("../assets/joshua.glb", function (gltf) {
...
for (let i = 0; i < 8; i++) {
  gltfLoader.load("../assets/man.glb", function (gltf) {
    var man = gltf.scene;
...
var mixer5;
var action5;
gltfLoader.load("../assets/robo.glb", function (gltf) {
  robot = gltf.scene;
  gltf.scene.traverse(function (node) {
    if (node.isMesh) {
      node.castShadow = true;
